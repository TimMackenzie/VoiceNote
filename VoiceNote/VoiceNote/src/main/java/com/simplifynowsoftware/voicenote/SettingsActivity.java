...
/**
 *  This class is primarily derivative from the SDK examples, and should be reviewed in light of
 *  updated design guidelines (and relevant example code).
 *  Comments and coding style are a little inconsistent due to this.
 */
